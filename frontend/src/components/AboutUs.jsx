...
function AboutUs() {
  return (
    <div 
  id="about" 
  className="bg-white border-l-8 border-t-8 border-pink-500 p-8 text-center rounded-xl w-2/3 
